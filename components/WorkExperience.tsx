...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      {/* Section Title */}
      <h3 className="absolute top-20 md:top-24 uppercase tracking-[20px] text-textSecondary text-xl md:text-2xl">
        Experience
      </h3>

      <div className="relative w-screen h-3/4 md:h-2/3 md:w-full text-left pb-5 md:pb-10">
        {/* Left and Right Fade Gradients */}
        <div className="absolute left-0 top-0 h-full w-16 bg-gradient-to-r from-primary to-transparent pointer-events-none z-10" />
        <div className="absolute right-0 top-0 h-full w-16 bg-gradient-to-l from-primary to-transparent pointer-events-none z-10" />
